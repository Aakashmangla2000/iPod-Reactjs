...
class Playing extends Component {
    ...
    render() {
        ...
        <p className="r-t" style={{position:"absolute",zIndex:"100",margin:"0",marginLeft:"300px",marginTop:"199px",color:"gray"}}>{parseInt((tm-this.audio.currentTime)/60)}:{((ts-sec)%60)>9?'':'0'}{(ts-sec)%60}</p>
                    ...
                    <img alt='' src="../rewind.svg" className="rewind r2"></img>
                    <img alt='' src="../fast_forward.svg" className="fastForw f2"></img>
                    <button style={{position:"absolute",margin:'0',marginTop:"225px",marginLeft:"150px"}} className="music-btn" onClick={this.togglePlay}><img alt='' style={{height:"13px"}} src="../play_pause.svg"></img></button>
                </div>
        )
    }
}
